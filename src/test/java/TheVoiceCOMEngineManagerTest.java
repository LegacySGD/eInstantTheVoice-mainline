...
public class TheVoiceCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TheVoiceCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TheVoiceIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TheVoiceIW/InitOutcome.xml").getDocumentElement();
